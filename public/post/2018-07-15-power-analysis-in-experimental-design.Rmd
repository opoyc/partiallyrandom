...
+ Type I: Probability of rejecting the null hypothesis when it is true (false positive)  
$$P()$$
+ Type II: Probability of not rejecting (accepting duh) the null hypothesis when it is false (false negative)
